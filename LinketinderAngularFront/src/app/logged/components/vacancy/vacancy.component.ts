...
export class VacancyComponent implements OnInit {
  ...
  async addNewVacancy(){
    this.loggedPerson = await this.vacancyService.addVacancy(this.loggedPerson, this.vacancyTitle, this.vacancySkills)
    this.addVacancy= !this.addVacancy;
  }

  async deleteVacancy(title:string){
    this.loggedPerson = await this.vacancyService.deleteVacancy(this.loggedPerson,title)
